...
const T_DARK = {
  ...
  miniWrapper: 'bg-neutral-950/95 backdrop-blur-md border-t border-white/10 text-white pb-[env(safe-area-inset-bottom)]',
...
const T_LIGHT = {
  ...
  miniWrapper: 'bg-[oklch(98.8%_0.003_106.5)]/95 backdrop-blur-md border-t border-stone-900/10 text-stone-900 pb-[env(safe-area-inset-bottom)]',
