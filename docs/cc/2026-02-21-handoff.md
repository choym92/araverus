...
- ✅ Updated docs:
  ...
  - `docs/4-news-backend.md`: Added failure taxonomy table with blockable/non-blockable distinction
...
| `docs/4-news-backend.md` | Added failure taxonomy table | ~244-264 |
...
| `docs/cc/google-news-search-flow.md` | NEW: Full pipeline documentation |
